  ...
  return (
    ...
    <section id='about' className='section' ref={ref}
     style={{
        ...
        <br/>
        <br/>
        Since then, I've been on a mission to stay up-to-date with the latest software and tools, completing the Three.js course to further improve my knowledge and skills. I also have a strong interest in 3D animation and love using Blender to create unique and engaging designs.<span className='dev_text'> "If you're on a desktop hover your mouse here to see cool spacehip".</span>
        <br/>
        <br/>
