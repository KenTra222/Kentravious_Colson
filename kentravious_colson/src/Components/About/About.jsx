  ...
  return (
    ...
    <section id='about' className='section' ref={ref}>
          ...
          <div className='bioWrapper'>
            <h2>Biography</h2>
            <p>Hi my name is Kentravious Colson! I'm a Creative Developer specializin in user experince and customer marketing. I started my journey in the tech space in 2014 as an audio engineer and as the years passed by fell in love with software development. I love to create engaging design that  </p>
